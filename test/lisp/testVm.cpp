...
// TEST(VM, func)
// {
//     std::vector<Byte> const instructions = {kICONST, 0, 0, 0, 11, kCALL, 0, 0, 0, 0, 0, 0, 0, 1, kHALT, kGET_LOCAL, 0, 0, 0, 0, kPRINT};
...
// TEST(VM, func2)
// {
//     std::vector<Byte> const instructions = {kICONST, 0, 0, 0, 11, kCALL, 0, 0, 0, 0, 0, 0, 0, 1, kPRINT, kHALT, kGET_LOCAL, 0, 0, 0, 0, kICONST, 0, 0, 0, 2, kIADD, kSET_LOCAL, 0, 0, 0, 1, kGET_LOCAL, 0, 0, 0, 1, kRET};
